var eventSchema = {
	...
	"properties": {
		"tab1": {
			...
			"ini": { label:"Fecha Inicio", id:"ini", name: "ini", type: "text", cls: "shared_space_fields_left"},
			"end": { label:"Fecha Fin", id:"end", name: "end", type: "text", cls: "shared_space_fields_right"},
			"hstr": { label:"Hora Inicio", id: "hstr", name: "hstr", type: "text", cls: "shared_space_fields_left"},
			"hend": { label:"Hora Termino", id: "hend", name: "hend", type: "text",cls: "shared_space_fields_right" },
